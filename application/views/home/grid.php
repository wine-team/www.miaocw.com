...
<div id="content" class="w home-content">
	...
	<div class="home-condom">
		<p class="lh35">&nbsp;</p>
		<div class="h_tt over">
			<em class="flor left">1F</em>
			<h2 class="left">
				<a target="_blank" href="<?php echo site_url('goods/search?category_id=25');?>" class="h_ha">避孕套</a>
				<em class="gray pl5 f16">CONDOM</em>
			</h2>
			<p class="right">
				<a href="<?php echo site_url('goods/search?category_id=51');?>" target="_blank" class="gray">超薄体贴</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=53');?>" target="_blank" class="gray">倍爽润滑</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=54');?>" target="_blank" class="gray">女用特色</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=55');?>" target="_blank" class="c9">冰火果味</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=56');?>" target="_blank" class="c9">浮点颗粒</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=57');?>" target="_blank" class="c9">超凡持久</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=58');?>" target="_blank" class="c9">螺纹刺激</a>
				<em class="vline">|</em>
				<a href="<?php echo site_url('goods/search?category_id=59');?>" target="_blank" class="c9">超值组合</a>
				<em class="vline">|</em>
