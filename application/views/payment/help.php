    	...
    	<table width="100%" border="0" class="o_wt lh25">
      		<tbody>
			    ...
			    <tr>
			        ...
			        <td>注册登陆后，在个人中心点击我的订单即可查看。<p>&nbsp;</p></td>
			        <td>为了尽快送达您的宝贝，我们会在当天立即邮寄。正常情况下，大中城市约1-3天能到，中小城市约3-5天能到，请耐心等候！<p>&nbsp;</p></td>
			    </tr>
				<tr>
      			...
      			<tr>
			        ...
			        <td>如果您不满意商品，请根据相关规定办理退换货。查看<a href="<?php echo $this->config->help_url.'help_center/index/15.html';?>" target="_blank" class="U red">退/换货详细规则</a></td>
        		</tr>
    		</tbody>
    	</table>
	</div>
